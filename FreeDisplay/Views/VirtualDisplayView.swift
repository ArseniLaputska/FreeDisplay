...
struct VirtualDisplayView: View {
    @State private var service = VirtualDisplayService.shared
    ...
    var body: some View {
                ...
                CreateVirtualDisplayForm(isCreating: $isCreating, onConfirm: { config in
                    ...
                    Task { @MainActor in
                        ...
                        if success {
                            ...
                            createError = String(localized: "Virtual display creation failed, please try again")
                            Task { @MainActor in
        ...
        .alert("Confirm Delete", isPresented: Binding(
            ...
            if let id = configToDelete, service.isActive(id) {
                Text("This virtual display is active and will be disabled immediately.")
            } else {
